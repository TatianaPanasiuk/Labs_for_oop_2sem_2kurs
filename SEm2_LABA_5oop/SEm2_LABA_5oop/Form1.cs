    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonSaveInFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (var p in searchOrgResult)
            {
                ...
                Proizvod = abstractTovar.createProizvoditel(p.Org, p.Strana, p.Adres, p.Telefon);
            }
        ...
        private void lABA5maybeToolStripMenuItem_Click(object sender, EventArgs e)
        {
